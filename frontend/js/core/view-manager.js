        ...
        return `
            <div class="extras-container">
                ...
                <div class="card-responsive mb-4">
                    <div class="card-body-responsive">
                        <div class="table-responsive-custom" style="max-height: 10.2rem; min-height: 2.6rem; overflow-y: auto;">                                                                      <table class="table table-striped table-hover table-custo
m" style="font-size: 0.80rem;">                                                                                      <thead class="table-dark">
                                    <tr>
                                        <th>Alias</th>
...
2"></i>Transferências</h5>                                                                               </div>
                    <div class="card-body-responsive">
                        <div class="table-responsive-custom" style="max-height: 20rem
; min-height: 2.6rem; overflow-y: auto;">                                                                        <table class="table table-striped table-hover table-custo
m" style="font-size: 0.80rem;">                                                                                      <thead class="table-dark">
                                    <tr>
                                        <th>Alias</th>
