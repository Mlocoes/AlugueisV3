                ...
                <div class="d-flex justify-content-end mb-3">
                    <button class="btn btn-primary admin-only" id="btn-novo-imovel">
                        <i class="fas fa-plus me-2"></i>Novo Imóvel
                                                                                                ...
                                                                                                </div>                                                                                    <div class="card-responsive">
                    <div class="card-body-responsive">
                        <div class="table-responsive-custom" style="max-height: 75vh;
 min-height: 55vh; overflow-y: auto;">                                                                           <table class="table table-striped table-hover table-custo
m" id="imoveis-table" style="font-size: 0.8rem;">                                                                    <thead class="table-dark">
                                    <tr>
                                        <th>Nome<br><span style="font-weight: normal;
 color: inherit; font-size: inherit;">Tipo</span></th>                                                                       <th>Endereço</th>
                                        <th>Área Total<br><span style="font-weight: n
ormal; color: inherit; font-size: inherit;">Construída</span></th>                                                           <th>Valor Cadastral<br><span style="font-weig
ht: normal; color: inherit; font-size: inherit;">Mercado</span></th>                                                         <th>IPTU<br><span style="font-weight: normal;
 color: inherit; font-size: inherit;">Condomínio</span></th>                                                                 <th>Alugado</th>
                                        <th>Data Cadastro</th>
 ...
 py-4">                                                                                                                          <div class="spinner-border" role="status"
>                                                                                                                                    <span class="visually-hidden">Carregando...
</span>                                                                                                                    </div>
            ...
            <div class="modal fade" id="novo-imovel-modal" tabindex="-1" aria-labelledby="novoImovelModalLabel">                                                                          <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="novo-imovel-modal-title">Novo
 Imóvel</h5>                                                                                                     <button type="button" class="btn-close" data-bs-dismiss="
modal" aria-label="Close"></button>                                                                          </div>
                        <div class="modal-body" style="font-size: 0.8rem; padding: 1r
em;">                                                                                                            <form id="form-novo-imovel">
                                <div class="row" style="margin-bottom: 0.25rem;">
                                    <div class="col-md-12 mb-1">
                                        <label for="imovel-nome" class="form-label" s
tyle="font-size: 0.85rem; margin-bottom: 0.1rem;">Nome do Imóvel *</label>                                                   <input type="text" class="form-control form-c
ontrol-sm" id="imovel-nome" name="nome" required style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                                                         </div>
                                </div>
                                <div class="mb-1">
                                    <label for="imovel-endereco" class="form-label" s
tyle="font-size: 0.85rem; margin-bottom: 0.1rem;">Endereço *</label>                                                     <input type="text" class="form-control form-contr
ol-sm" id="imovel-endereco" name="endereco" required style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                                                 </div>
                                <div class="mb-1">
                                    <label for="imovel-tipo" class="form-label" style
="font-size: 0.85rem; margin-bottom: 0.1rem;">Tipo</label>                                                               <input type="text" class="form-control form-contr
ol-sm" id="imovel-tipo" name="tipo_imovel" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                                                           </div>
                                <div class="row" style="margin-bottom: 0.25rem;">
                                    <div class="col-md-6 mb-1">
                                        <label for="imovel-area-total" class="form-la
bel" style="font-size: 0.85rem; margin-bottom: 0.1rem;">Área Total (m²)</label>                                              <input type="number" step="0.01" class="form-
control form-control-sm" id="imovel-area-total" name="area_total" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                                        </div>
                                    <div class="col-md-6 mb-1">
                                        <label for="imovel-area-construida" class="fo
rm-label" style="font-size: 0.85rem; margin-bottom: 0.1rem;">Área Construída (m²)</label>                                                                                                                         <input type="number" step="0.01" class="form-
control form-control-sm" id="imovel-area-construida" name="area_construida" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                              </div>
                                </div>
                                <div class="row" style="margin-bottom: 0.25rem;">
                                    <div class="col-md-6 mb-1">
                                        <label for="imovel-valor-cadastral" class="fo
rm-label" style="font-size: 0.85rem; margin-bottom: 0.1rem;">Valor Cadastral</label>                                         <input type="number" step="0.01" class="form-
control form-control-sm" id="imovel-valor-cadastral" name="valor_cadastral" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                              </div>
                                    <div class="col-md-6 mb-1">
                                        <label for="imovel-valor-mercado" class="form
-label" style="font-size: 0.85rem; margin-bottom: 0.1rem;">Valor Mercado</label>                                             <input type="number" step="0.01" class="form-
control form-control-sm" id="imovel-valor-mercado" name="valor_mercado" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                                  </div>
                                </div>
                                <div class="row" style="margin-bottom: 0.25rem;">
                                    <div class="col-md-6 mb-1">
                                        <label for="imovel-iptu" class="form-label" s
tyle="font-size: 0.85rem; margin-bottom: 0.1rem;">IPTU Mensal</label>                                                        <input type="number" step="0.01" class="form-
control form-control-sm" id="imovel-iptu" name="iptu_mensal" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                                             </div>
                                    <div class="col-md-6 mb-1">
                                        <label for="imovel-condominio" class="form-la
bel" style="font-size: 0.85rem; margin-bottom: 0.1rem;">Condomínio Mensal</label>                                            <input type="number" step="0.01" class="form-
control form-control-sm" id="imovel-condominio" name="condominio_mensal" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                                 </div>
                                </div>
                                <div class="row" style="margin-bottom: 0.25rem;">
                                    <div class="col-md-4 mb-1">
                                        <label for="imovel-quartos" class="form-label
" style="font-size: 0.85rem; margin-bottom: 0.1rem;">Quartos</label>                                                         <input type="number" class="form-control form
-control-sm" id="imovel-quartos" name="numero_quartos" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">                                                                                                   </div>
                                    <div class="col-md-4 mb-1">
                                        <label for="imovel-banheiros" class="form-label" style="font-size: 0.85rem; margin-bottom: 0.1rem;">Banheiros</label>
                                        <input type="number" class="form-control form-control-sm" id="imovel-banheiros" name="numero_banheiros" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">
                                    </div>
        ...
        return `
            <div class="participacoes-container">
                ...
                <div id="participacoes-table-container" style="display: none;">
                    <div class="card-responsive">
                        <div class="card-body-responsive">
                            <div class="table-responsive-custom" style="max-height: 70vh; min-height: 50vh; overflow-y: auto; overflow-x: auto;">                                                         <table class="table table-striped table-hover matriz-
table table-custom" id="participacoes-matrix-table" style="font-size: 0.76rem;">                                         <thead class="table-dark" id="participacoes-matri
x-head" style="white-space: nowrap;">                                                                                        <tr>
                                            <th width="120">Ações</th>
                                        </tr>
                                    </thead>
                                    <tbody id="participacoes-matrix-body" style="whit
e-space: nowrap;">                                                                                                           <tr>
                                            <td colspan="1" class="text-center text-m
uted py-4">                                                                                                                          <div class="spinner-border" role="sta
tus">                                                                                                                                    <span class="visually-hidden">Car
regando...</span>                                                                                                                    </div>
            ...
            <div class="alugueis-container">
                ...
                <div class="row mb-3 align-items-center">
                        <div class="col-md-3 d-flex align-items-center">
                            <label for="alugueis-ano-select" class="form-label mb-0 me-4" style="min-width: 60px;">Ano</label>                                                                        <select id="alugueis-ano-select" class="form-select">
                                <option value="">Selecione o ano</option>
                            </select>
                        </div>
                        <div class="col-md-3 d-flex align-items-center">
                            <label for="alugueis-mes-select" class="form-label mb-0 me-4" style="min-width: 80px;">Mês</label>                                                                        <select id="alugueis-mes-select" class="form-select" disa
bled>                                                                                                            <option value="">Selecione o mês</option>
                ...
                <div id="alugueis-table-container" style="display: none;">
                    <div class="card-responsive">
                        <div class="card-body-responsive">
                            <div class="table-responsive-custom" style="max-height: 70vh; min-height: 50vh; overflow-y: auto;">                                                                           <table class="table table-striped table-hover matriz-
table table-custom" id="alugueis-matrix-table" style="font-size: 0.76rem;">                                              <thead class="table-dark" id="alugueis-matrix-hea
d">                                                                                                                      </thead>
