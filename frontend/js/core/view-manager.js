...
class ViewManager {
    ...
    getImportarAccordionItem(type, title, icon, accordionId) {
...
irmar-exclusao-imovel">Excluir</button>                                                                      </div>
 ...
 flex-wrap: wrap;">                                                                                              <div class="d-flex align-items-center me-3">
                                <label for="relatorios-ano-select" class="form-label 
mb-0 me-2" style="min-width: 50px;">Ano</label>                                                                      <select id="relatorios-ano-select" class="form-select
" style="width: 160px; min-width: 140px;">                                                                               <option value="">Carregando...</option>
                                </select>
                            </div>
                            <div class="d-flex align-items-center me-3">
                                <label for="relatorios-mes-select" class="form-label 
mb-0 me-2" style="min-width: 50px;">Mês</label>                                                                      <select id="relatorios-mes-select" class="form-select
" style="width: 160px; min-width: 140px;">                                                                               <option value="">Todos os meses</option>
...
rm-label mb-0 me-2" style="min-width: 80px;">Proprietário</label>                                                    <select id="relatorios-proprietario-select" class="fo
rm-select" style="width: 200px; min-width: 160px;">                                                                      <option value="">Carregando...</option>
                                </select>
                            </div>
                            <div class="d-flex align-items-center">
                                <input class="form-check-input me-2" type="checkbox" 
id="relatorios-transferencias-check">                                                                                <label class="form-check-label" for="relatorios-trans
ferencias-check">                                                                                                        <i class="fas fa-exchange-alt me-1"></i>Transferê
ncias                                                                                                                </label>
                            </div>
                        </div>
                ...
                <div class="card-responsive">
                    ...
                    <div class="card-body-responsive">
                            <div class="table-responsive-custom" style="max-height: 70vh; min-height: 50vh; overflow-y: auto;">                                                                       <table class="table table-striped table-hover table-custo
m" style="font-size: 0.76rem;">                                                                                      <thead class="table-dark">
                                    <tr>
                                        <th width="50">Nº</th>
                                        <th>Nome do Proprietário</th>
                                        <th width="120" class="text-center">Período</
th>                                                                                                                          <th width="150" class="text-end">Soma dos Alu
guéis</th>                                                                                                                   <th width="150" class="text-end">Soma das Tax
as de Administração</th>                                                                                                     <th width="150" class="text-center">Imóveis</
th>                                                                                                                      </tr>
                                </thead>
